...
import com.lw.bean.TAdminRole;
import com.lw.bean.TAdminRoleExample;
...
public interface TAdminRoleMapper {
    ...
    void saveAdminAndRoleRealitonShip(@Param("roleIds") Integer[] roleId,@Param("adminId") Integer adminId);

    void deleteAdminAndRoleRealitonShip(@Param("roleIds") Integer[] roleId,@Param("adminId") Integer adminId);
}