            ...
            <div class="panel-body">
                <form id="updateForm" role="form" action="${PATH}/admin/doUpdate" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" value="${admin.username}" name="username" placeholder="请输入用户名称">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">邮箱地址</label>
                        <input type="email" class="form-control" id="exampleInputEmail1" value="${admin.email}" name="email" placeholder="请输入邮箱地址">
